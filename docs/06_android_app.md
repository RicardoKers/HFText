...
- The Android UI can reset local operator settings from Diagnostics while preserving message history and evidence files; the reset callsign is `nocall`.
