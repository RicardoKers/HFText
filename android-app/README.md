...
TX audio, RX sample rate, audio statistics, and streaming RX updates through this
native path. Audio playback starts only after the operator presses `Send audio`.
...
counters, and received messages.
