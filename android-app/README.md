...
- up to 100 recent received messages are shown in a scrollable timestamped panel
...
time from the last accepted message to evidence save, received messages, the
