...
- accepted RX messages shown in a timestamped history, plus receiver status shown in the UI;
...
updates through this native path. Audio playback starts only after the operator presses `Send audio`.
